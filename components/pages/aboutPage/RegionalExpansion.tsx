      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="max-w-4xl mx-auto space-y-3">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-2 text-xl md:text-2xl font-medium pt-2">
            <span className="flex items-center gap-2"><span className="text-white text-3xl leading-none">•</span> Bihar (Primary focus)</span>
            <span className="flex items-center gap-2"><span className="text-white text-3xl leading-none">•</span> Jharkhand</span>
            <span className="flex items-center gap-2"><span className="text-white text-3xl leading-none">•</span> West Bengal</span>
            <span className="flex items-center gap-2"><span className="text-white text-3xl leading-none">•</span> Odisha</span>
            <span className="flex items-center gap-2"><span className="text-white text-3xl leading-none">•</span> Assam</span>
          </div>
